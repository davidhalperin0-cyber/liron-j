...
const VALUES = [
  ...
  { title: "איכות", description: "אנחנו בוחרים חומרים איכותיים — ציפוי זהב עמיד, כסף 925, זרקונים נוצצים ואבנים טבעיות" },
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="space-y-4 text-white/50 leading-relaxed">
              ...
              <p>
                הצוות שלנו מורכב מעצבים ואנשי מקצוע שחולקים חזון משותף — ליצור תכשיטים שגורמים לכל אישה להרגיש מיוחדת.
              </p>
            </div>
          </div>
        </div>
