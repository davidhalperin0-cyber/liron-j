...
המוצר צריך להגיע במצב מקורי. ההחזר הכספי מתבצע תוך 14 ימי עסקים. החלפות — ללא עלות נוספת.`;
      ...
      case "material_info":
        reply = `אנחנו עובדים עם ציפוי זהב וציפוי רוז גולד איכותיים, כסף 925 וזרקונים נוצצים. בקו הגברים — אבנים טבעיות (אוניקס, עין הנמר, לבה), צדף טבעי ופלדת אל-חלד.

יש אחריות על פגמי ייצור ו-14 יום להחזרה.
