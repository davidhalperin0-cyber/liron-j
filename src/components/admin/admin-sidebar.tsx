...
const NAV_ITEMS = [
  ...
  { label: "קודי הנחה", href: "/admin/promos", icon: Ticket },
  { label: "הזמנות", href: "/admin/orders", icon: ShoppingCart },
  { label: "בדיקת סליקה", href: "/admin/test-charge", icon: CreditCard },
  { label: "לקוחות", href: "/admin/customers", icon: Users },
  { label: "ימי הולדת", href: "/admin/birthdays", icon: Cake },
  { label: "דף הבית", href: "/admin/homepage", icon: Home },
  { label: "מוצרים מומלצים", href: "/admin/featured", icon: Sparkles },
