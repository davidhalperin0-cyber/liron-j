...
export const SEED_PRODUCTS: ProductDetail[] = [
  {
    ...
    description: "טבעת יהלום מרהיבה בהשראת כוכבי הלילה, עם מרכז נוצץ וכתר עדין של יהלומים קטנים.",
    story: "הטבעת הזו נולדה מתוך רגע של השראה בלילה חשוך על גג הסטודיו. כל זווית נבנתה כדי לתפוס אור אחר, כמו כוכב שנע בשמיים.",
    price: 6800,
    compareAtPrice: 7800,
